                ...
                <div class="sp-slide"><img src="/uploads/slider/{{$slider->image}}" alt="slider" class="sp-image"/>
                  <div class="container">
                    ...
                    <div data-width="100%" data-show-transition="right" data-hide-transition="left" data-show-duration="800" data-show-delay="1200" data-hide-delay="400" class="sp-layer">
                      <div class="main-slider-meta"><span class="main-slider-meta__item">{{$slider->sliderConversations->created_at->format('d.m.Y')}}</span><span class="main-slider-meta__item"><i class="icon pe-7s-comment"></i>{{$slider->sliderConversations->imagestyle}}</span></div>
                    </div>
                  </div>
                </div>
                @else
                        ...
                        <div class="row">
                            <div class="col-md-6 con_new_plus">
                               <ul class="nav nav-tabs nav-tabs_sm nav-tabs_primary">
                                  <li class="active"><a href="/">ШИНЭ</a></li>
                                  <li><a href="/commend">ИХ УНШСАН</a></li>
                               ...
                               <article class="white-panel"> 
                                ...
                                <div class="entry-main">
                                  <div class="entry-header">
                                   ...
                                   <!--  <p class="name_001"> <i>О.Баасанхүү: </i> </p>  --><p class="text_001"> 
                                 
                                  {!! \Illuminate\Support\Str::limit ($conversation->title, 51,'....')  !!}</p> 
                                      </h2>
                                    </a>
                                  </div>  
