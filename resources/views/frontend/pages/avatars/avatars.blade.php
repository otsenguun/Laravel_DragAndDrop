          ...
          <section class="section-default" id="sec_01">
            <div class="container">
              <div class="row">
                <div class="col-xs-12">
                  <div class="clearfix">
                    <h2 class="ui-title-block"><span class="text-uppercase">Хөрөг</span></h2>
                      <div class="container">
                        <div class="row">
                            <div class="col-md-6 con_new_plus">
                               <ul class="nav nav-tabs nav-tabs_sm nav-tabs_primary">
                                  <li><a href="figure1" >ИХ СЭТГЭГДЭЛТЭЙ</a></li>
                                  <li><a href="figure2" >их уншисан</a></li>
                                  <li class="active"><a href="figure" >шинээр нэмэгдсэн</a></li>
                                </ul>
                  ...
                  <div class="spinner" id="spinner" style="display: none;">
                    ...
                    <div class="rect5"></div>
                      ...
                      <div class="container load_001">
                        <div class="text-right" style="padding-right: 50px;">{{ $conversations->links() }}</div>
