          ...
          <section class="section-default" id="sec_01">
            <div class="container">
              <div class="row">
                <div class="col-xs-12">
                  <div class="clearfix">
                    <h2 class="ui-title-block"><span class="text-uppercase">Нийтлэл</span></h2>
                      <div class="container">
                        <div class="row">
                            <div class="col-md-6 con_new_plus">
                               <ul class="nav nav-tabs nav-tabs_sm nav-tabs_primary">
                                  <li><a href="articles1">ИХ СЭТГЭГДЭЛТЭЙ</a></li>
                                  <li><a href="articles2">их уншисан</a></li>
                                  <li class="active"><a href="articles" >шинээр нэмэгдсэн</a></li>
                                </ul>
